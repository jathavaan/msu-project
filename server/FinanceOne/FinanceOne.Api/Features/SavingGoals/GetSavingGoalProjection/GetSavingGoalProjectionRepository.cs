...
public interface IGetSavingGoalProjectionRepository
{
...
public sealed class GetSavingGoalProjectionRepository(FinanceOneDbContext context) : IGetSavingGoalProjectionRepository
{
